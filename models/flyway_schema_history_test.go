...
func testFlywaySchemaHistoriesDelete(t *testing.T) {
	...
	count, err := FlywaySchemaHistories().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testFlywaySchemaHistoriesQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := FlywaySchemaHistories().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testFlywaySchemaHistoriesExists(t *testing.T) {
	...
	e, err := FlywaySchemaHistoryExists(ctx, tx, o.InstalledRank)
	if err != nil {
...
func testFlywaySchemaHistoriesFind(t *testing.T) {
	...
	flywaySchemaHistoryFound, err := FindFlywaySchemaHistory(ctx, tx, o.InstalledRank)
	if err != nil {
		t.Error(err)
	}
...
func testFlywaySchemaHistoriesBind(t *testing.T) {
	...
	if err = FlywaySchemaHistories().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testFlywaySchemaHistoriesOne(t *testing.T) {
	...
	if x, err := FlywaySchemaHistories().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testFlywaySchemaHistoriesAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = flywaySchemaHistoryOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = flywaySchemaHistoryTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := FlywaySchemaHistories().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func flywaySchemaHistoryBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}

func flywaySchemaHistoryAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}

func flywaySchemaHistoryAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}

func flywaySchemaHistoryBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}

func flywaySchemaHistoryAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}

func flywaySchemaHistoryBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}

func flywaySchemaHistoryAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}

func flywaySchemaHistoryBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}

func flywaySchemaHistoryAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *FlywaySchemaHistory) error {
	*o = FlywaySchemaHistory{}
	return nil
}
...
func testFlywaySchemaHistoriesInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(flywaySchemaHistoryColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
