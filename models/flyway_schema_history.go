...
func FlywaySchemaHistories(mods ...qm.QueryMod) flywaySchemaHistoryQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`flyway_schema_history`.*"})
	}
...
func (o *FlywaySchemaHistory) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
