...
var OrderWhere = struct {
	...
	OrderID:   whereHelpernull_Int{field: "`orders`.`order_id`"},
	UserID:    whereHelpernull_Int{field: "`orders`.`user_id`"},
	RecipeID:  whereHelpernull_Int{field: "`orders`.`recipe_id`"},
	Quantity:  whereHelpernull_Int{field: "`orders`.`quantity`"},
	Price:     whereHelpernull_Int{field: "`orders`.`price`"},
	AddressID: whereHelpernull_Int{field: "`orders`.`address_id`"},
}
...
var (
	orderAllColumns            = []string{"id", "order_id", "user_id", "recipe_id", "quantity", "price", "address_id"}
	orderColumnsWithoutDefault = []string{"order_id", "user_id", "recipe_id", "quantity", "price", "address_id"}
